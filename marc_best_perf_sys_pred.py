...
if __name__ == "__main__":
    ...
    # Load trained model.
    model.load_model('trained_models/.trained_muri_cnn_9x9_batch30_SGD.h5')
    #pred_results = model.predict(test_X[:100])
    act_results = model._get_layer_output(test_X[:100])
    import cPickle
    with open('tmp_input_activation.plk','w') as f:
        #cPickle.dump(act_results,f)
        cPickle.dump(test_X[:100],f)
    pdb.set_trace()
	# Train NN
